  ...
  return (
    <div className="group inline-block text-left relative" ref={ref}>
      <button
        ...
        type="button"
        className={`inline-flex w-full justify-center items-center gap-1 h-[28px] rounded-lg px-1 py-1 text-md whitespace-nowrap hover:text-[#3B3BFC] dark:hover:text-scanDark ${className}`}
      >
